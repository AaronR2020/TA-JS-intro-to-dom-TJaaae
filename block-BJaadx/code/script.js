...
document.head.querySelector(`title`).innerText="Hello AltCampus!";
...
console.log(`${document.body.querySelector(`ul`).children.length}`);
// 4. Select the first input using the `type` selector and store them in variable named `emailInput`
emailInput=document.querySelector(`fieldset>input`);
...
let allTopics=document.querySelectorAll('ul>li')
...
console.log(`the total no of img on this page is ${img.length}`);
// 16. Select all the `p` element and store in `allPElement`
let allPElement=document.querySelectorAll(`p`);
// 17. Select all the buttons and log the count of buttons.
let button=document.querySelectorAll(`button`)
console.log(`the total no of buttons on this page is ${button.length}`);
// 18. Select all the `label` element and log the count.
let labelCount=document.querySelectorAll(`label`)
console.log(`the total no of labels on this page is ${labelCount.length}`);
...
topics.lastElementChild.innerText=`This is the last child element`
