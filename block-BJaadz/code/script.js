...
allHrsArray.map((val)=>{return val.style.border="1px solid tomato"})
// Change the background of all the hr to "antiquewhite" using for of loop.
allHrsArray.map((val)=>{return val.style.backgroundColor="antiquewhite"})
// Change the 'border-radius' of all the hr to "5px" using array.
allHrsArray.map((val)=>{return val.style.borderRadius="5px"})
